...
Version  : 5.14.2
Release  : 8
URL      : https://download.kde.org/stable/plasma/5.14.2/kdeplasma-addons-5.14.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.2/kdeplasma-addons-5.14.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.2/kdeplasma-addons-5.14.2.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.14.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540468320
mkdir -p clr-build
pushd clr-build
%cmake ..
