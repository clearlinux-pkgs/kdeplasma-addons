...
Version  : 5.16.1
Release  : 22
URL      : https://download.kde.org/stable/plasma/5.16.1/kdeplasma-addons-5.16.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.1/kdeplasma-addons-5.16.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.1/kdeplasma-addons-5.16.1.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.16.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1560869702
mkdir -p clr-build
pushd clr-build
