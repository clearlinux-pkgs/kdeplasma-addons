...
Source0  : https://download.kde.org/stable/plasma/6.3.1/kdeplasma-addons-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/kdeplasma-addons-6.3.1.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.3.1
cd %{_builddir}/kdeplasma-addons-6.3.1
pushd ..
cp -a kdeplasma-addons-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739918634
mkdir -p clr-build
pushd clr-build
