...
Source0  : https://download.kde.org/stable/plasma/5.27.9/kdeplasma-addons-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/kdeplasma-addons-5.27.9.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.27.9
cd %{_builddir}/kdeplasma-addons-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701985070
mkdir -p clr-build
pushd clr-build
