...
Source0  : https://download.kde.org/stable/plasma/6.0.4/kdeplasma-addons-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kdeplasma-addons-6.0.4.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.0.4
cd %{_builddir}/kdeplasma-addons-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713322041
mkdir -p clr-build
pushd clr-build
