...
Version  : 6.2.4
Release  : 115
URL      : https://download.kde.org/stable/plasma/6.2.4/kdeplasma-addons-6.2.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.4/kdeplasma-addons-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/kdeplasma-addons-6.2.4.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.2.4
cd %{_builddir}/kdeplasma-addons-6.2.4
pushd ..
cp -a kdeplasma-addons-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735337538
mkdir -p clr-build
pushd clr-build
