...
Source0  : https://download.kde.org/stable/plasma/6.4.0/kdeplasma-addons-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/kdeplasma-addons-6.4.0.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.4.0
cd %{_builddir}/kdeplasma-addons-6.4.0
pushd ..
cp -a kdeplasma-addons-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750201785
mkdir -p clr-build
pushd clr-build
...
%find_lang plasma_runner_colors
...
/V3/usr/lib64/qt6/plugins/kf6/krunner/krunner_colors.so
...
/usr/lib64/qt6/plugins/kf6/krunner/krunner_colors.so
