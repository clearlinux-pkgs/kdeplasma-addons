...
Source0  : https://download.kde.org/stable/plasma/6.0.5/kdeplasma-addons-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/kdeplasma-addons-6.0.5.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.0.5
cd %{_builddir}/kdeplasma-addons-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716502273
mkdir -p clr-build
pushd clr-build
