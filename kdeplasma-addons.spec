...
Source0  : https://download.kde.org/stable/plasma/6.3.3/kdeplasma-addons-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/kdeplasma-addons-6.3.3.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.3.3
cd %{_builddir}/kdeplasma-addons-6.3.3
pushd ..
cp -a kdeplasma-addons-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742565823
mkdir -p clr-build
pushd clr-build
