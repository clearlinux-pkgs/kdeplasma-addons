...
Source0  : https://download.kde.org/stable/plasma/5.27.3/kdeplasma-addons-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/kdeplasma-addons-5.27.3.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.27.3
cd %{_builddir}/kdeplasma-addons-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679521030
mkdir -p clr-build
pushd clr-build
