...
Source0  : https://download.kde.org/stable/plasma/6.1.3/kdeplasma-addons-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kdeplasma-addons-6.1.3.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.1.3
cd %{_builddir}/kdeplasma-addons-6.1.3
pushd ..
cp -a kdeplasma-addons-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721159585
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/qt6/plugins/potd/plasma_potd_natgeoprovider.so
...
/usr/lib64/qt6/plugins/potd/plasma_potd_natgeoprovider.so
