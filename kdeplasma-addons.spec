...
Source0  : https://download.kde.org/stable/plasma/5.16.2/kdeplasma-addons-5.16.2.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.2/kdeplasma-addons-5.16.2.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.16.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1561473482
mkdir -p clr-build
pushd clr-build
