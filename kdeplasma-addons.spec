...
Source0  : https://download.kde.org/stable/plasma/6.1.1/kdeplasma-addons-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kdeplasma-addons-6.1.1.tar.xz.sig
...
%setup -q -n kdeplasma-addons-6.1.1
cd %{_builddir}/kdeplasma-addons-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719435331
mkdir -p clr-build
pushd clr-build
