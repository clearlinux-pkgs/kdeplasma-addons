...
Version  : 5.27.10
Release  : 94
URL      : https://download.kde.org/stable/plasma/5.27.10/kdeplasma-addons-5.27.10.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.10/kdeplasma-addons-5.27.10.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.10/kdeplasma-addons-5.27.10.tar.xz.sig
...
%prep
%setup -q -n kdeplasma-addons-5.27.10
cd %{_builddir}/kdeplasma-addons-5.27.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702980392
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/qt5/plugins/kf5/krunner/kcms/kcm_krunner_dictionary.so
/usr/lib64/qt5/plugins/kf5/krunner/kcms/kcm_krunner_spellcheck.so
...
/usr/lib64/qt5/plugins/kf5/krunner/org.kde.datetime.so
...
/usr/lib64/qt5/plugins/potd/plasma_potd_simonstalenhagprovider.so
